  ...
  return (
    <>
      <div className={`${loading ? 'animate-pulse ' : ''} w-full gap-5 md:gap-1 grid text-center md:grid-cols-2 lg:w-full lg:mb-0 lg:grid-cols-2`}>
        {loading ? (
          <>
            <div className={`rounded-md md:m-3 p-2 md:p-8 ${themeApp === "dark" ? "bg-slate-900" : "bg-[#2c4efa3f]"} flex flex-col justify-between space-y-4 scale-100 hover:scale-105 delay-0 duration-300 ease-in-out`}>
              ...
              <div className="shadow shadow-blue-500/40 flex justify-around justify-items-center p-2">
                ...
                <div className="flex flex-col text-center justify-center">
                  <div className="shadow shadow-blue-500/55 p-1 flex flex-col text-center justify-center justify-items-center h-8">
                    ...
                    >
                      <img
                        src="/image/next-right.png"
                        alt="Link do repositório"
                        className="bg-transparent invert w-6"
                      />
                    </a>
                  </div>
                </div>
            ...
            {Array.isArray(repository) && repository.map((repo) => (
              <div
                ...
                <div className="border border-sky-800 rounded-md flex justify-around justify-items-center p-2">
                  ...
                  <div className="flex flex-col text-center justify-center">
                    <div className="border border-sky-800 rounded-sm p-1 flex flex-col text-center justify-center justify-items-center h-8 transition-all duration-300 scale-90 hover:scale-110">
                      <a
                        href={repo?.html_url}
                        rel="noopener noreferrer"
                        target="_blank"
                      >
                        <img
                          src="/image/next-right.png"
                          alt="Link do repositório"
                          className="bg-transparent invert w-5"
                        />
                      </a>
                    </div>
                  </div>
